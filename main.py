# modified from https://github.com/EmilienDupont/coinpp
...
def add_arguments(parser):
    ...
    # Model arguments
    parser.add_argument(
        "--num_layers", help="Number of layers in base network.", type=int, default=8
    )
    ...
    parser.add_argument(
        "--outer_lr", help="Learning rate for the outer loop.",
        # type=float, default=3e-6
...
def main(args):
    if args.use_wandb:
        ...
        model_path = "/BaseModel_S-0501.pth"
